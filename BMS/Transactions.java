...
//         ImageIcon i1 = new ImageIcon(getClass().getResource("/icons/atm.jpg")); // Adjusted path
//         Image i2 = i1.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT);
//         ImageIcon i3 = new ImageIcon(i2);
//         JLabel image = new JLabel(i3);
//         image.setBounds(0, 0, 900, 900);
...
//         setSize(900, 900);
//         setLocation(300, 0);
//         setUndecorated(true); // Optional: remove if you want window decorations
//     }
...
//     public static void main(String args[]) {
//         // This main method is just for testing; it won't be used in production.
//         new Transactions("");
//     }
// }
