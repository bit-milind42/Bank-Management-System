...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        ImageIcon i1 = null;
    	try {
    	    i1 = new ImageIcon(ImageIO.read(new File("C:/Users/milin/OneDrive/Desktop/Bank Mangement System/src/icons/logo.jpg")));
    	} catch (IOException e) {
    	    System.err.println("Error loading logo image: " + e.getMessage());
    	    i1 = new ImageIcon("C:/path/to/default/logo.jpg"); // Fallback path
    	}
